 ...
 *    License: MIT
 *
 *    https://github.com/Rookfighter/inifile-cpp.git
 */
...
namespace ini
{
    ...
    public:
        ...
        {
            if (value_ == "")
                throw std::runtime_error("This variable does not exist as a char *");
        ...
        {
            if (value_ == "")
                throw std::runtime_error("This variable does not exist as a string");
        ...
        {
            if (value_ == "")
                throw std::runtime_error("This variable does not exist as a int");
        ...
        {
            if (value_ == "")
                throw std::runtime_error("This variable does not exist as a unsigned int");
        ...
        {
            if (value_ == "")
                throw std::runtime_error("This variable does not exist as a float");
        ...
        {
            if (value_ == "")
                throw std::runtime_error("This variable does not exist as a double");
        ...
        {
            if (value_ == "")
                throw std::runtime_error("This variable does not exist as a bool");
    ...
    public:
        ...
        void decode(std::istream &is)
        {
            ...
            while(!is.eof() && !is.fail())
            {
                ...
                // lets remove the white space from each line
